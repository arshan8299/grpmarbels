...
import homeVideo from "/videos/grp_marbels.mp4"

const Home = () => {
  return (
    <>
      <Box sx={{ width: "100vw", height: { xs: "75vh", md: "100vh" }, position: "absolute", top: 0, left: 0, zIndex: -1 }}>
        <video src={homeVideo} controls={false} autoPlay loop muted playsInline style={{ objectFit: "cover", width: "100%", height: "100%" }} />
      </Box>
      <Box
